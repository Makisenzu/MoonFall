...
document.getElementById('registrationForm').addEventListener('submit', function(event) {
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            submitBtn.disabled = false;
            submitBtn.innerHTML = originalBtnText;
            messageDiv.innerHTML = '<div class="alert alert-danger">Location permission denied. Please enable location services to continue.</div>';
        });
    } else {
        submitBtn.disabled = false;
        submitBtn.innerHTML = originalBtnText;
        messageDiv.innerHTML = '<div class="alert alert-danger">Geolocation is not supported by your browser.</div>';
    }
});
